...
<html lang="en">
  <head>
    <title>Adyaconnect Pvt Ltd</title>
    <meta charset="utf-8" />
  ...
  <body>
    <div id="wrapper">
      ...
      <div
        ...
        style="background-image: url(images/giphy.gif)"
      >
        <div class="background-slider owl-carousel">
          ...
          <div
            class="bg-slider-img"
            style="background-image: url(images/slide-04.jpg)"
          ></div> -->
        </div>
        <!--/.background-slider-->
      </div>
                          ...
                          <div class="row">
                            <div class="col-sm-6">
                              <div class="counter-box">
                                <span class="count-number">350</span
                                ><!--/.count-number-->
                                Projects Completed
                              </div>
                              <!--/.counter-box-->
                            ...
                            <div class="col-sm-6">
                              <div class="counter-box">
                                <span class="count-number">9000</span
                                ><!--/.count-number-->
                                Lines of code
                              </div>
                              <!--/.counter-box-->
                    ...
                    <div class="col-md-6 animate" data-animate="fadeInUp">
                      <div class="contact-box">
                        ...
                        <div class="contact-row">
                          ...
                          <a href="https://goo.gl/maps/GVGnJAiQ4AQSFAbW9"
                            >Patanikunnu Ln, Sasthamangalam, Thiruvananthapuram,
                            <br />
                            Kerala 695010</a
                          >
                        </div>
        ...
        <div class="container-fluid">
          <div class="footer-row">
            ...
            <div class="subscribe-section">
              <a href="#" class="btn btn-xs btn-outline btn-subscribe"
                >Subscribe</a
              >
              <div class="subscribe-row">
                <div class="row align-items-center">
                  <div class="col-lg-3">
                    ...
                    <p>
                      Get Latest News, Information, Notifications &
                      Announcements
                    </p>
                  </div>
            ...
            <div class="footer-right">
              &copy; 2020 Aadyaconnect. All Rights Reserved | Powered by
