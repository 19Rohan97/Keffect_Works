jQuery(document).ready(function ($) {
  ...
  $(".wpsk-swiper-carousel").each(function (index) {
    ...
    var slider_conf = $.parseJSON(
      $(this).closest(".wpsk-carousel-wrap").find(".wpsk-carousel-conf").text()
    );
    ...
    if (typeof slider_id != "undefined" && slider_id != "") {
      var swiper = new Swiper("#" + slider_id, {
        ...
        paginationType:
          slider_conf.pagination_type == "fraction" ? "fraction" : "bullets",
        autoplay:
          slider_conf.autoplay == "true"
            ? parseInt(slider_conf.autoplay_speed)
            : "",
        ...
        coverflow: {
          rotate: parseInt(slider_conf.rotate),
          stretch: parseInt(slider_conf.stretch),
        ...
        breakpoints: {
          ...
          480: {
            slidesPerView:
              parseInt(slider_conf.slide_to_show) > 2
                ? 2
                : parseInt(slider_conf.slide_to_show),
          },
          // when window width is <= 640px
          640: {
            slidesPerView:
              parseInt(slider_conf.slide_to_show) > 3
                ? 3
                : parseInt(slider_conf.slide_to_show),
          },
        },
