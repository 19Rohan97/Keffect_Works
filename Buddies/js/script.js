(function () {
  ...
  var karla = {
    ...
    enablePreloader: function () {
      var preloader = $("#karla-page-loading").delay(1000);
  ...
  $(".testimonials .owl-carousel").owlCarousel({
    ...
    nav: false,
    navText: [
      "<i class='lnr ti-angle-left'></i>",
      "<i class='lnr ti-angle-right'></i>",
    ],
    responsiveClass: true,
    responsive: {
      0: {
  ...
  $(document).ready(function () {
    $(
      ".popup-youtube, .popup-vimeo, .popup-gmaps, .popup-custom"
    ).magnificPopup({
      disableOn: 700,
      type: "iframe",
      mainClass: "mfp-fade",
