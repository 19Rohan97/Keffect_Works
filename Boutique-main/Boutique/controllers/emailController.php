...
function sendVerificationEmail($userEmail, $token)
{
    ...
    <body>
        <div class="wrapper">
            <p>Thank you for joining Boutique. Hope you enjoy shopping with us!</p>
    ...
    //         <a href="http://localhost/Keffect_Works/Boutique-main/Boutique/index.php?token=' . $token . '">Verify Your Mail</a>
    //     </div>
...
function sendPasswordResetLink($userEmail, $token)
{
    ...
    <body>
        <div class="wrapper">
            ...
            <a href="http://localhost/Keffect_Works/Boutique-main/Boutique/header2.php?password-token=' . $token . '">Reset Password</a>
        </div>
